...
# -------------------------------------------------
  ...
  # 3 Philopatric/remain in the release area, not yet breeding at age 2 year (inside the study area)
  # 4 Philopatric/remain in the release area, 3 year or older, breeder (inside the study area)
  # 5 Philopatric/remain in the release area, 3 year or older (inside the study area) that skips
  #   reproduction
  # 6 Non-philopatric/not remain in the release area, not yet breeding at age 2 year (inside the
  #   study area)
  # 7 Non-philopatric/not remain in the release area, breeder (inside the study area)
  # 8 Non-philopatric/not remain in the release area, breeder (inside the study area) that skips  
  #   reproduction
  # 9 Alive outside study area
  # 10 Recently dead by roadkill and recovered
  # 11 Recently dead by other causes and recovered
  # 12 Long-time dead (absorbing state)
  # Observations (O):
  # 1 Seen as juvenile
  ...
  # 5 Seen as philopatric non-breeder (inside the study area) (i.e. experienced breeder that skips 
  #   reproduction)
  ...
  # 8 Seen as non-philopatric non-breeder (inside the study area) (i.e. experienced breeder that 
  #   skips reproduction)
  ...
  # 8 Recently dead by road-kill and recovered
  # 9 Recently dead by other causes and recovered
  # 10 Long-time dead (absorbing state)
  # Observations (O):
...
params <- c('Dd.obs','Dd.rep',
            ...
            's1F','rk1F','o1F','mean.mr1F','mean.mo1F','sigma.mr1F','sigma.mo1F',
